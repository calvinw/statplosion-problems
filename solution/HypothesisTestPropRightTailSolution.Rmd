---
pagetitle: "Hypothesis Testing - Proportions Right Tail Test"
params:
  count: 102
  n: 250 
  p: 0.34
...
$$
P = \text{right tail area} = 1.0 - `r area` = `r round(right_area,4)` 
$$


So based on this our conclusion is that this is **`r hypothesis_test_conclusion(1.0-area)` against the null hypothesis**.    
